# -*- coding: utf-8 -*-
import requests
import pygame # 请安装pygame: pip install pygame
import os
import pandas as pd
import time
pygame.init()
font = pygame.font.Font("./config/GUGUbot/fonts/MicrosoftYaHei-01.ttf", 26)
...
class Bot:
    ...
    def text2image(input_string):
        ...
        image_path = "/".join(os.getcwd().split("\\"))+"/config/GUGUbot/image/{}.jpg".format(int(time.time()))
