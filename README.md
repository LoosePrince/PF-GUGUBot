...
本插件修改自： [QQChat-用于连接Minecraft和QQ的插件 - 已失联](https://github.com/AnzhiZhang/MCDReforgedPlugins/tree/master/qq_chat) [QQChat新版 - 仅做参考，可能是同一个插件，但并不修改于此版本](https://github.com/AnzhiZhang/MCDReforgedPlugins/tree/master/src/qq_chat) [原作者：AnzhiZhang](https://github.com/AnzhiZhang) <br>
