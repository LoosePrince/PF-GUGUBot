...
class QQHandler(BasicHandler):
    ...
    def __init__(self, bot_config, system_manager: Optional[SystemManager] = None) -> None:
        """初始化基础处理器。
