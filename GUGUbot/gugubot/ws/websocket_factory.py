...
class WebSocketFactory:
    ...
    @staticmethod
    def create_bridge_server(config: Any, logger: Optional[logging.Logger] = None) -> WebSocketServer:
        """根据配置创建桥接服务器
    ...
    @staticmethod
    def create_bridge_client(config: Any, logger: Optional[logging.Logger] = None) -> WebSocketClient:
        """根据配置创建桥接客户端
